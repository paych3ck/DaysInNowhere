label din_winterlong_story:
    ...
    din_narrator "От решения меня отвлек новый гость, рывком открывший дверь. В руках он держал два кухонных ножа, а так - ничего примечательного."
    din_pi_teapot "Девочки и мальчики, берегите ваши щи и пальчики! {w}А еще лучше - просто испаритесь на счет три."
    ...
    din_narrator "Гость похоже, собирался уходить, но заметил, что какая-то дефектная кукла еще сидит в столовой. Аккуратно разглядывая, он взял нож лезвием вперед и медлено пошел ко мне."
    ...
    din_narrator "Я грузно сел обратно за свой трапезный стол."
    ...
    din_third "Не сочти за грубость, но плевать я хотел на этот праздник и на вашу чудотворную Зиму."
    din_teapot "Да не будь ты старым нудным пнём, Третий. Забудь о её предыстории. Тебе там тоже найдется чем заняться. Тем более праздник общий для всех. Везде кроме нас будет пусто."
    ...
    din_narrator "Не слишком равномерно, местами были практически незадетые ветви, но с земли это было мало заметно."
    din_narrator "Я высыпал последний мешок по ветру, нанеся последний штрих праздничному виду поляны."
    ...
    din_narrator "Практически все уже закончили свою часть работы. В центре спало пока незажженное кострище, вокруг него расходились скромные места, чтобы хватило всем желающим. В отдалении находилась небольшая деревянная платформа для выступлений."
    din_narrator "Она нужна для исследователей, которым в любое время неймется обсудить с кем-то свои идеи. Так что им выделили отдельный уголок, где собираются единомышленники. В результате все остались относительно довольны."
    din_narrator "Зимний вид поляны навевал слабознакомое ощущение. Неделя Зимы выдается очень редко. Многие даже не помнят, что когда-то были на ней."
    din_narrator "Только я и еще пара-тройка Пионеров никогда не забывают традицию. В этом времени еще Чайник запомнил, но вряд ли он сможет повторить такой результат много раз."
    din_narrator "Из-за такой редкости Неделя Зимы была чем-то невероятным, дарящим подлинное счастье не помнящим прошлого новичкам. Во взглядах помнящих, бывает, можно проскакивает бессильная зависть к этой беззаботности."
    ...
    din_narrator "Чайник вместе с какими-то двумя личностями зажег костёр. Дрова тихо затрещали, давая дорогу огню."
    ...
    din_narrator "Небольшая группа любопытствующих пошла послушать странные речи исследователей."
