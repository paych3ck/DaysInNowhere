label din_ikarus_story:
    ...
    $ din_onload("unlock")
    play music din_the_last_days_the_time_will_never_come_back fadein 5
    ...
    din_narrator "Но факт фактом: в этих электропередачах самого электричества {i}нет{/i}."
    ...
    din_narrator "Зато! Всегда есть возможность выкорчевать эту розетку и носить её с собой, как вечный двигатель. {w}Удобно? Удобно!"
    ##звук порыва ветра
    nvl clear
    din_teapot "Га-а-а-а!"
    ...
    din_narrator "Так что теперь я был похож на пухлую куклу-шаталку, а не на человека."
    ...
    din_teapot "Ты — мой первый приоритет при падении, так что и в горе и в радости я утащу тебя на дно с собой."
    ...
    din_narrator "Устроившись поудобнее, насколько это вообще возможно с помощью трёх хлипких железных ниточек, я принялся разворачивать свой плащ-палатку."
    nvl clear
    din_teapot "Что застрял? Помогай давай, солнце еще в зените."
    din_nit "Куда это ты спешишь?"
    ...
    din_nit "Не только про него. {w}Я тебе рассказывал про кружок амбициозных художников?"
    ...
    din_nit "Да, идея очень любопытная. Но кого именно вызывать на помощь? {w}В библиотеке есть только упоминания о каббалистических трудах. {w}Тупик."
    ...
    din_nit "Тем не менее, в этом бреде довольно четко описывалась сущность и «‎ритуал призыва»."
    ...
    if persistent.font_size == "large":
        din_teapot "{size=32}А{/size}{size=31}А{/size}{size=30}А{/size}{size=29}А{/size}{size=28}А{/size}{size=27}А{/size}{size=26}А{/size}{size=25}А{/size}{size=24}А{/size}{size=23}А{/size}{size=22}А{/size}{size=21}А{/size}{size=20}А{/size}{size=19}А{/size}{size=18}!{/size}{size=17}!{/size}{size=16}!{/size}"

    elif persistent.font_size == "small":
        din_teapot "{size=28}А{/size}{size=27}А{/size}{size=26}А{/size}{size=25}А{/size}{size=24}А{/size}{size=23}А{/size}{size=22}А{/size}{size=21}А{/size}{size=20}А{/size}{size=19}А{/size}{size=18}А{/size}{size=17}А{/size}{size=16}А{/size}{size=15}А{/size}{size=14}!{/size}{size=13}!{/size}{size=12}!{/size}"
    ...
    din_narrator "В диком вращении себя вокруг собственной оси мне удалось выхватить лыбящуюся рожу Нита."
...
label din_ikarus_story_interlude:
    ...
    din_third_i "А нужно?"
    din_nit_he "Рискуешь запутаться в собственных мыслях. Потом не сможешь в памяти отличить меня от себя."
    din_third_i "Это произойдет еще не скоро."
    din_nit_he "Когда живёшь не ограниченную никаким сроком жизнь, то приходится планировать всё на пару шагов вперёд."
    din_third_i "Зато в моей жизни, по крайней мере, будут сюрпризы."
    din_nit_he "Самообман. Палка о двух концах."
    ...
    din_nit_he "Не выслушав? Странно. Я ждал от тебя другого ответа."
    ...
    din_nit_he "Скорее знаю. {w}В вечности меняется всё, кроме неё самой."
    din_nit_he "Увидимся."
