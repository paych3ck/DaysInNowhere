label din_ikarus_story:
    ...
    din_narrator "Нет, я не был НАСТОЛЬКО толстым. Но огромное покрывало, которое я сшил своими трудолюбивыми руками и закрепил на себе десятками метров гитарных струн, делало меня открытым всем ветрам."
    ...
    din_teapot "Ты про того третьего Третьего? Мне кажется, он немного того."
